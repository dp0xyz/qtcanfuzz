#ifndef BYTE_ARRAY_MUTATOR_H_
#define BYTE_ARRAY_MUTATOR_H_
...
public:
    ...
    void MutateMany(std::vector<ByteArray> &inputs, size_t num_mutants,
                    long unsigned int crossover_level, std::vector<ByteArray> &mutants);
    void MutateOne(std::vector<ByteArray> &inputs,
